...
import cupy as cp
from myself_data.dataset_4th_32x32 import load_4th_32x32_dataset
from simple_convnet import SimpleConvNet
from common.trainer import Trainer

#データセットをロード
(x_train, t_train), (x_test, t_test) = load_4th_32x32_dataset(normalize=True, one_hot_label=True)
