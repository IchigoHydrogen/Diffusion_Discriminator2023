...
# 画像の保存先のディレクトリ
save_dir='C:/here/////myself_data/dataset_4th_32x32'
# 画像の読み込み元のディレクトリ
image_dir = 'C:/here/////myself_data/dataset_4th_32x32'
...
def load_4th_32x32_dataset(normalize=True,flatten=True,one_hot_label=False):
    # 訓練用データセットをロード
    x_train = np.load('C:/here/////myself_data/dataset_4th_32x32/x_train.npy')
    y_train = np.load('C:/here/////myself_data/dataset_4th_32x32/y_train.npy')
    # テスト用データセットをロード
    x_test = np.load('C:/here/////myself_data/dataset_4th_32x32/x_test.npy')
    y_test = np.load('C:/here/////myself_data/dataset_4th_32x32/y_test.npy')
